//Validation credit card function
$(function () {
    $.fn.extend({
        ccvalidate: function(options) {
            ...
            var cards = new Array();
           //Different credit card, different expression
            ...
            return this.each(function() {
                var type = $(this).find('.ddlCCtype');
                var cardnumber = $(this).find('.txtCCNumber');
                var confirm = $(this).find('.btnConfirm');
